...
const Noosuturee = JSON.parse(typeof $response != "undefined" && $response.body || null);
...
const list = {
  'Offsuit': { name: 'Offsuit Premium', id: 'com.offsuit.offline_sub_year_3599', cm: 'sjb' },  //Offsuit德州
  ...
  'Aphrodite': { name: 'all', id: 'com.ziheng.aphrodite.lifetime', cm: 'sjb' },  //Aphrodite-啪啪啪日历
...
try {
    let matchTarget = (typeof ua !== "undefined" ? ua : (typeof bundle_id !== "undefined" ? bundle_id : "未知/Unknown"));
  
    if (typeof $response == "undefined") {
      delete headers["x-revenuecat-etag"];
      delete headers["X-RevenueCat-ETag"];
      Noosuture.headers = headers; 
    } else if (Noosuturee && Noosuturee.subscriber) {
      Noosuturee.subscriber.subscriptions = Noosuturee.subscriber.subscriptions || {};
      Noosuturee.subscriber.entitlements = Noosuturee.subscriber.entitlements || {};
      ...
      if (!name || !ids) {
        data = { "purchase_date": "2023-09-09T09:09:09Z", "expires_date": "2099-09-09T09:09:09Z" };
        name = 'pro';
        ids = 'com.Noosuturee.pro';
      } 
      
      Noosuturee.subscriber.entitlements[name] = Object.assign({}, data, { product_identifier: ids });
      
      if (typeof nameb !== 'undefined' && nameb !== null) {
        Noosuturee.subscriber.entitlements[nameb] = Object.assign({}, data, { product_identifier: idb });
      }
      ...
      Noosuturee.subscriber.subscriptions[ids] = subData;
      
      if (typeof idb !== 'undefined' && idb !== null) {
        Noosuturee.subscriber.subscriptions[idb] = subData;
      }
